...
<div class="row justify-content-center mt-5">
    <div class="p-3 btn btn-outline-info text-light col-md-5 border-0">
        <main class="form-registration">
            ...
            <form action="{{ url('pesanan/'.$alat->id) }}" method="post" class="">
                @csrf
                <input type="hidden" name="_method" value="PATCH">
                <div class="form-floating">
                    <label for="Nama">Nama </label>
                    <input type="text" class="form-control" name="name" placeholder="Nama" value="{{ $alat->name }}" autocomplete="off">
                </div>
                <div class="form-floating">
                    <label for="nomor">No Hp/Wa</label>
                    <input type="text" class="form-control" name="number" placeholder="No Hp/Wa" value="{{ $alat->number }}" autocomplete="off">
                </div>
                <div class="form-floating">
                    <label for="nomor">satuan harga</label>
                    <input type="text" class="form-control" name="price" value="{{ $alat->price }}" placeholder="satuan harga" autocomplete="off">
                </div>
                <div class="form-floating">
