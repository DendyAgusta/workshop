...
<div class="row justify-content-center">
    <div class="btn btn-light col-md-5">
        <main class="form-registration">
            <table class="table">
                <tr>
                    <th>
                        <h1 class="mb-3 fw-normal text-center text-dark">REGISTRASI FROM</h1>
                    </th>  
                </tr>
                <tr>
                    <td>
            ...
            <form action="/register" method="post">
                ...
                <button class="w-50 btn btn-dark mt-2" type="submit">Register</button>
            </form>
            <small class="d-block text-center mt-3"><a href="/" class="text-dark">Login</a></small>
